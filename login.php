...
<head>
    ...
    <title>CarWise - อัพเดทราคาน้ำมัน</title>
...
<body>
    ...
    <nav class="navbar">
        <div class="logo">CarWise <span class="badge">TH</span></div>
        <div class="nav-menu">
            <a href="index.html" class="nav-link">🔍 ค้นหารถ</a>
            <a href="oil.html" class="nav-link ">⛽ ราคาน้ำมัน</a>
            <a href="login.html" class="nav-link active">🔐 เข้าสู่ระบบ</a>
        </div>
    </nav>
